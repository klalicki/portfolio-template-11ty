        ...
        e.exports = (function () {
            ...
            for (
              ...
              if (((s += e.slice(i, l)), (i = l + h.length), f))
                ...
                if (!c && s.length) {
                  var w = s.length - 1,
                    P = s[w];
                  (!u || u.indexOf(P) > -1) && ((p = P), (s = s.slice(0, w)));
                }
                s && (n.push(s), (s = ""), (c = !1));
                var k = d || m,
                  S = p || a;
          ...
          function P(e, t) {
            for (var r = new Array(e.length), n = 0; n < e.length; n++)
              "object" == typeof e[n] &&
                (r[n] = new RegExp("^(?:" + e[n].pattern + ")$", k(t)));
            return function (t, n) {
              for (
                var o = "",
          ...
          var A = {
                ...
                var r = (function () {
                  if (!t.next.html)
                    return Promise.resolve(e).then(function (e) {
                      ...
                      if (e) {
                        var n = L.toElement(e);
                        (r.namespace = L.getNamespace(n)),
                          (r.container = L.getContainer(n)),
                          (r.html = e),
            ...
            M = function (e) {
              ...
              var u = i.indexOf("?");
              return (
                u >= 0 && ((s = C(i.slice(u + 1))), (i = i.slice(0, u))),
          ...
          var U = new ((function (e) {
                  ...
                  if (this.registered.has(e)) {
                    ...
                    return (
                      this.registered.get(e).forEach(function (e) {
                        i = i.then(function () {
                          return B(e.fn, e.ctx).apply(void 0, n);
                        });
                      }),
                      i.catch(function (r) {
            ...
            G = function (e) {
              var t = e.el;
              return void 0 !== t.port && H() !== H(t.href);
            },
            Q = function (e) {
              var t = e.el;
              return (
                  ...
                  if (o ? l && l[u] : l[u]) {
                    switch (t.type) {
                      ...
                      case "object":
                        ...
                        p[h]
                          ? (p[h].name &&
                              -1 !== d.indexOf(p[h].name) &&
                              (s = !0),
                            -1 === d.indexOf(p[h].name) && (i = !1))
                          : (i = !1);
                        break;
                      case "function":
                        l[f](r) ? (s = !0) : (i = !1);
            ...
            ne = (function () {
              ...
              return (
                    ...
                    var s = u(
                      function () {
                        return Promise.resolve(o.j("beforeOnce", t, i)).then(
                          function () {
                            return Promise.resolve(o.once(t, i)).then(
                              function () {
                                return Promise.resolve(
                                  o.j("afterOnce", t, i)
                                ).then(function () {});
                  ...
                  try {
                    ...
                    var f = u(
                      function () {
                        ...
                        var r = (function () {
                          if (h)
                            return Promise.resolve(q(n, t)).then(
                              function () {}
                            );
                        })();
                        return r && r.then ? r.then(e) : e();
                ...
                (r.once = function (e, t) {
                  try {
                    return Promise.resolve(U.do("once", e, t)).then(
                      function () {
                ...
                (r.leave = function (e, t) {
                  try {
                    return Promise.resolve(U.do("leave", e, t)).then(
                      function () {
                ...
                (r.enter = function (e, t, r) {
                  try {
                    return Promise.resolve(U.do("enter", e, t)).then(
                      function () {
                        return t.enter
                          ? B(t.enter, t)(e, r)
                          : Promise.resolve();
                ...
                (r.j = function (e, t, r) {
                  try {
                    return Promise.resolve(U.do(e, t, r)).then(function () {
                      return r[e] ? B(r[e], r)(t) : Promise.resolve();
                    });
                  } catch (e) {
                    return Promise.reject(e);
                  }
              ...
              return (
                (e.prototype.L = function (e) {
                  ...
                  return function (r) {
                    ...
                    return o && o[e] ? B(o[e], o)(r) : Promise.resolve();
                  };
                }),
                e
              );
                  ...
                  var s = i.cache.has(e)
                    ...
                    a = (function () {
                      if (i.transitions.shouldWait)
                        return Promise.resolve(q(s, i.data)).then(
                          function () {}
                        );
                    })();
            ...
            return (
              ...
              (t.start = function (e, t) {
                try {
                  ...
                  return (
                    r.add(e, t),
                    Promise.resolve(r.barba.helpers.nextTick()).then(
                      function () {
                        return (
                          r.add(e, t + "-active"),
                          Promise.resolve(r.barba.helpers.nextTick()).then(
              ...
              (t.i = function (e, t) {
                try {
                  var r = this;
                  return Promise.resolve(r.barba.hooks.do("once", e, t)).then(
                    function () {
              ...
              (t.s = function (e, t) {
                try {
                  var r = this;
                  return Promise.resolve(r.barba.hooks.do("leave", e, t)).then(
                    function () {
              ...
              (t.h = function (e, t) {
                try {
                  var r = this;
                  return Promise.resolve(r.barba.hooks.do("enter", e, t)).then(
                    function () {
    ...
    (() => {
      ...
      document
        ...
        .addEventListener("click", () => {
          document.querySelector(i).classList.toggle(s);
        }),
        t().use(o()),
        t().init({
          prevent: ({ el: e }) =>
            e.classList && e.classList.contains("barba-prevent"),
          transitions: [{ name: "fade", leave() {}, enter() {} }],
        });
      const a = (e) => {
        e.preventDefault(), console.log(e);
      };
      document.querySelectorAll(".portfolio-tile").forEach((e) => {
        e.addEventListener("touchstart", a);
      }),
        (window.hideItems = () => {
          document.querySelectorAll(".text-page > *").forEach((e) => {
            e.classList.add("transition-hide-item");
          });
        }),
        (window.showItems = () => {
          document.querySelectorAll(".text-page > *").forEach((e, t) => {
            setTimeout(() => {
              e.classList.remove("transition-hide-item");
            }, 100 * t);
          });
        }),
        ...
        t().hooks.before((e) => {
          var t;
          document.querySelector(i).classList.add(s),
            document.querySelectorAll(".active").forEach((e) => {
              e.classList.remove("active");
            }),
            (t = e.next.url.path),
            document
              .querySelectorAll(".sidebar-nav-link-section a")
              .forEach((e) => {
